...
<div id="container">
    ...
    <div class="box-content">
        <p>Register for free by clicking the Create Your Beebo -button below. If you have already registered, please sign in on the right.</p>
        <div class="register-button clearfix">
            <a href="{{ site.sitePath }}/register" onclick="HabboClient.closeHabboAndOpenMainWindow(this); return false;">Create Your Beebo »</a>
            <span></span>
        </div>                
    </div>
</div>
