...
<div id="friend-invitation-habblet-container" class="box-content">
    ...
    <div id="invitation-link-container">
        ...
        <div class="copytext">
            <p>Invite your friends to Beebo and earn cool badges! Send a link to your friend and ask them to register and activate their email. If they are using Beebo in active way you get rewarded with a badge.</p>
        </div>
