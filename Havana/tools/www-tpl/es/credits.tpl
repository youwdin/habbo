...
<script type="text/javascript">
    ...
    <div class="credit-info-text clearfix"><img class="credits-image" src="{{ site.sitePath }}/web-gallery/v2/images/credits_permission.png" width="114" height="136"/><p class="credits-text">Siempre solicite permiso a su padre o tutor antes de comprar Beebo Monedas.Si no hace esto y el pago se cancela o rechazó, será prohibido permanentemente.</p></div>
