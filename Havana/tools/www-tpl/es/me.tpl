    ...
    <div id="habbo-feed">
		...
		{% for alert in alerts %}	
			...
			<li id="feed-item-hc-reminder">
				...
				<div>Your Beebo Club is expired. Do you want to extend your Beebo Club?	</div>
				<div class="clearfix">
                ...
                <h2 class="title">
                  ...
                  <span class="habblet-close" id="habblet-close-roomselection" onclick="RoomSelectionHabblet.showConfirmation()"></span>
                    ...
                    Hey! You haven't chosen your pre-decorated room, which comes with free furniture! Choose one below:
                        ...
                        L10N.put("roomselection.old_user.done", "And you\'re done! Beebo Hotel will now open in a new window and you\'ll be redirected to your room in no time!");
    ...
    <ul id="hotcampaigns-habblet-list">
        ...
        <li class="odd">
            <div class="hotcampaign-container">
                ...
                <p>Join Beebo Club today and get access to exclusive furniture!</p>
...
<div id="friend-invitation-habblet-container" class="box-content">
    ...
    <div id="invitation-link-container">
        ...
        <div class="copytext">
            <p>¡Invita a tus amigos a Beebo y gana insignias geniales! Envía un enlace a tu amigo y pídele que se registre y active su correo electrónico. Si usan Beebo de forma activa, serás recompensado con una insignia.</p>
        </div>
