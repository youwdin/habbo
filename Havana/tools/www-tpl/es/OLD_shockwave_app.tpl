					...
					<div class="tutorial-text">	
						<div class="row">
							...
							<div class="text-column" style="width: 260px">
								<p>As the years go by so do the browser plugins. Shockwave is a browser plugin that is deprecated in most modern browsers, due to this a portable program that runs Shockwave Beebo is avaliable.</p>
								<p>This is a Macromedia Projector program generated with Director MX 2004. Written in the same language that the Shockwave Beebo client is written in.</p>
							</div>
						</div>
					...
					<div class="tutorial-text">	
						...
						<div class="row">
							...
							<div class="column" style="margin-top:10px; margin-bottom:10px; margin-left:10px; width: 275px;">
								<p><b>BattleBall, Diving, Wobble Squabble, Trax Machines, Jukeboxes, American Idol, Tic Tac Toe, Chess, Battleships, Poker</b> and some nostalgic Beebo components such as the hand and the Room-o-Matic.</p>
							</div>
						</div> -->
					</div>
				</div>
