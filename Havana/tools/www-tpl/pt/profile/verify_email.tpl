...
<br /><br /><hr>
<div class="settings-step">
	<p>We have noticed that you have logged in with your Beebo account. In order to change your email you need to go to the account management settings page. Click the link below to enter the Beebo account change email page.</p>
	<p><a href="{{ site.sitePath }}/profile?tab=3">Go to the Beebo account change email page</a></p>
</div>
</div>
</div>
