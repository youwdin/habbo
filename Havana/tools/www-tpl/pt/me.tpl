                ...
                <h2 class="title">
                  ...
                  <span class="habblet-close" id="habblet-close-roomselection" onclick="RoomSelectionHabblet.showConfirmation()"></span>
                    ...
                    Ei! Você ainda não escolheu seu quarto pré-decorado, que vem com mobília grátis! Escolha um abaixo:
                        ...
                        L10N.put("roomselection.old_user.done", "Pronto! O Beebo Hotel abrirá em uma nova janela e você será redirecionado para o seu quarto rapidamente!");
...
<div id="friend-invitation-habblet-container" class="box-content">
    ...
    <div id="invitation-link-container">
        ...
        <div class="copytext">
            <p>Convide seus amigos para o Beebo e ganhe emblemas legais! Envie um link para seu amigo e peça para ele se cadastrar e ativar seu e-mail. Se eles estiverem usando o Beebo de forma ativa, você será recompensado com um distintivo.</p>
        </div>
